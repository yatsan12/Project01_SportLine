...
public class MyCalendarView extends LinearLayout {
    ...
    public MyCalendarView(final Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void SaveEvent(String event, String time, String date, String month, String year,String notify) {
        Log.d("SaveEvent", "Button clicked");
        dbOpenHelper = new DBOpenHelper(context);
        SQLiteDatabase database = dbOpenHelper.getWritableDatabase();
        dbOpenHelper.SaveEvent(event, time, date, month, year, notify, database);
        Log.d("SaveEvent", "back from dbOPenHelper save_event");
        dbOpenHelper.close();
        Toast.makeText(context, "事件已新增", Toast.LENGTH_SHORT).show();
    }
