...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(com.luseen.spacenavigation.R.styleable.SpaceNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(com.luseen.spacenavigation.R.dimen.space_item_icon_only_size));
            spaceBackgroundColor = typedArray.getColor(com.luseen.spacenavigation.R.styleable.SpaceNavigationView_space_background_color, resources.getColor(R.color.light_green));
            centreButtonColor = typedArray.getColor(com.luseen.spacenavigation.R.styleable.SpaceNavigationView_centre_button_color, resources.getColor(R.color.space_white));
            activeSpaceItemColor = typedArray.getColor(com.luseen.spacenavigation.R.styleable.SpaceNavigationView_active_item_color, resources.getColor(R.color.space_white));
            inActiveSpaceItemColor = typedArray.getColor(com.luseen.spacenavigation.R.styleable.SpaceNavigationView_inactive_item_color, resources.getColor(R.color.space_white));
            centreButtonIcon = typedArray.getResourceId(R.styleable.SpaceNavigationView_centre_button_icon, R.drawable.logo99);
            isCentrePartLinear = typedArray.getBoolean(R.styleable.SpaceNavigationView_centre_part_linear, true);
            ...
            inActiveCentreButtonIconColor = typedArray.getColor(R.styleable.SpaceNavigationView_inactive_centre_button_icon_color, resources.getColor(R.color.space_white));
            activeCentreButtonBackgroundColor = typedArray.getColor(R.styleable.SpaceNavigationView_active_centre_button_background_color, resources.getColor(R.color.space_white));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (centreButtonColor == NOT_DEFINED)
            centreButtonColor = ContextCompat.getColor(context, R.color.space_transparent);
    ...
    private void initAndAddViewsToMainView() {
        ...
        leftContentParams.addRule(LinearLayout.VERTICAL);
        leftContentParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        //leftContentParams.addRule(RelativeLayout.ALIGN_BASELINE);
        ...
        rightContentParams.addRule(LinearLayout.VERTICAL);
        rightContentParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
        //rightContentParams.addRule(RelativeLayout.ALIGN_BASELINE);
    ...
    private void addSpaceItems(LinearLayout leftContent, LinearLayout rightContent) {
        ...
        for (int i = 0; i < spaceItems.size(); i++) {
            ...
            if (i == currentSelectedItem) {
                ...
                Utils.changeImageViewTint(spaceItemIcon, activeCentreButtonBackgroundColor);
            } else {
    ...
    private void updateSpaceItems(final int selectedIndex) {
        ...
        for (int i = 0; i < spaceItemList.size(); i++) {
            if (i == selectedIndex) {
                ...
                ImageView spaceItemIcon = (ImageView) textAndIconContainer.findViewById(R.id.space_icon);
                TextView spaceItemText = (TextView) textAndIconContainer.findViewById(R.id.space_text);
                spaceItemText.setTextColor(activeCentreButtonBackgroundColor);
                Utils.changeImageViewTint(spaceItemIcon, activeCentreButtonBackgroundColor);
